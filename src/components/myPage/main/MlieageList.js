    ...
    <div className="cont history_mileage">
      ...
      <div className="history_inner">
        ...
        <div className="mileage_inquiry">
          <DateBox search={search} firstSearch={true} style={{ paddingBottom: '24px' }} />
        ...
        <div className="guide_list">
          ...
          <ul className="list_dot">
            ...
            <li>
              <strong>VIP회원</strong>(누적 구매 금액 <strong>200만원</strong> 이상부터 적용)은 구매 시 결제금액의 4%가
              적립됩니다. (2년 간 혜택 유지)
            </li>
            <li>
              마일리지 적립은 <strong>제품 구매일 당일</strong>에만 적립 가능합니다. (온라인 소니스토어 배송 완료 후 7일
              이내에 적립)
            </li>
            <li>
            ...
            <li>
              적립하신 마일리지는 소니스토어 온라인 및 직영점에서 제품 구매 시, 소니 공식 서비스 센터에서의 제품 수리 및
              콘텐츠 이용 시 사용 가능합니다.
            </li>
