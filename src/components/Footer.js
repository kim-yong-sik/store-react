        ...
        <div className="footer__inner">
              ...
              <div className="footer__family__links" ref={footerRef}>
                <div className={`footer__family__link footer__pc ${pcActive && 'footer__family__link--active'}`}>
                  <button
                    ...
                    onClick={() => (isMobile ? setMoActive() : setPcActive())}
                  >
                    Sony Family
                  </button>
                ...
                >
                  ...
                  <optgroup label="Family Company">
                    {SONY_COMPANY.map(({ url, name }) => (
                      <option value={url} key={`footer-ul-company-${name}`}>
                        {name}
                      </option>
                    ))}
                  </optgroup>
          ...
          <div className="footer__legal">
            <div className="footer__legal__links">
              <Link to="/footer/terms" className="footer__legal__link">
                이용약관
              </Link>
              <a
              ...
              <Link to="/footer/sitemap" className="footer__legal__link">
                사이트맵
              </Link>
            </div>
            <div className="footer__legal__warning">
              ...
              <p>
                고객님의 안정한 거래를 위해 현금 등의 거래를 통한 결제를 하실 경우,
          ...
          <address className="address">
            ...
            {isMobile ? (
              <span>
                <a href="tel:1588-0911">TEL : 소니코리아 고객센터 1588-0911</a>
              </span>
            ) : (
              <span>TEL : 소니코리아 고객센터 1588-0911</span>
            )}
            <span>
              E-MAIL : <a href="mailto:cshelp@sony.co.kr">cshelp@sony.co.kr</a>
            </span>
